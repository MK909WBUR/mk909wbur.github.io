...
(function() {
  ...
  function includeHTMLAuto(node) {
    ...
    for (var i = 0; i < includes.length; i++) {
      if (includes[i].getAttribute("src"))
        includeHTML(includes[i].getAttribute("src"), includes[i]);
      else if (includes[i].getAttribute("data-src"))
        includeHTML(includes[i].getAttribute("data-src"), includes[i]);
      else if (includes[i].getAttribute("data-include"))
        includeHTML(includes[i].getAttribute("data-include"), includes[i]);
    }
  }
